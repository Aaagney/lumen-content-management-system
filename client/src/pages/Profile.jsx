...
function Profile({ currentUser, onProfileUpdate }) {
  ...
  const fetchUserArticles = async () => {
    ...
    try {
      // Authors have articles; Readers might have 0
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      onProfileUpdate({ ...currentUser, fullname, bio });
      setIsEditing(false);
  ...
  if (!currentUser) {
    return (
      <div style={{ textAlign: "center", padding: "48px 0" }}>
        ...
        <p className="body-para">Please log in to view your profile.</p>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className="lumen-card profile-card">
        ...
        <div className="profile-info">
          {isEditing ? (
            <form onSubmit={handleUpdate} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <input
                ...
                style={{ paddingLeft: "14px", fontSize: "1.5rem", fontFamily: "var(--font-serif)", fontWeight: "bold" }}
                value={fullname}
              ...
              <div style={{ display: "flex", gap: "10px", marginTop: "4px" }}>
                <button type="submit" className="btn-forest" style={{ width: "auto", padding: "8px 16px" }} disabled={loading}>
                  <Save size={14} />
                ...
                <button 
                  ...
                  onClick={() => { setIsEditing(false); setFullname(currentUser.fullname); setBio(currentUser.bio); }}
                >
                  Cancel
                </button>
              </div>
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <h1 className="serif-title profile-name">{currentUser.fullname}</h1>
                <button 
          ...
          <div className="profile-stats">
            ...
            <div className="stat-item">
              <span className="stat-val">{totalLikes.toLocaleString()}</span>
      ...
      {articles.length > 0 ? (
            ...
            <div key={art.id} className="article-row-card">
              <div className="article-row-left">
                {art.image_url ? (
                  ...
                  <div className="article-row-img" style={{ backgroundColor: "#eae7de", display: "flex", alignItems: "center", justifyContent: "center", color: "#6b7280" }}>
                    <FileText size={18} />
                  </div>
                )}
        ...
        <div style={{ textAlign: "center", padding: "48px 24px", backgroundColor: "white", borderRadius: "16px", boxShadow: "0 4px 20px rgba(0,0,0,0.01)" }}>
          <p className="body-para">You haven't written any articles yet.</p>
        </div>
      )}
    </div>
  );
